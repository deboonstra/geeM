...
#'
#' @details mCIC is calculated based on the trace of the product of model-based
#' covariance matrices, where the referent variances are produced by the model
#' using the unstructured (i.e., general) correlation structure.
#'
...
#'
#' @export
mcic <- function(object, tol = .Machine$double.eps, envir = parent.frame()) {
